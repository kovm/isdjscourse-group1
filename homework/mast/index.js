...
function palindromeChecker (input) {
   ...
   const inputMiddleIndex = Math.floor(input.length / 2) + input.length % 2;
   const inputFirstHalf = input.slice(0, inputMiddleIndex);
   ...
   const inputSecondHalf = secondHalfReverted(input);
